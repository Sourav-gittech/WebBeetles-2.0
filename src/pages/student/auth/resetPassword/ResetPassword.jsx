...
import { studentForgetPassword, studentResetPassword, verifyOtpForReset } from '../../../../redux/slice/authSlice/studentAuthSlice'
...
const ResetPassword = () => {
    ...
    const handleResend = () => {
        ...
        dispatch(studentForgetPassword(resend_obj))
            .then(res => {
    ...
    const forgetPasswordDataHandler = (data) => {
        ...
        if (otpCode.length !== 8) {
            ...
            dispatch(studentResetPassword(reset_pass_obj))
                .then(async (res) => {
