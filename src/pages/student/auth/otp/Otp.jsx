...
import { studentEmailVerify, studentResendOTP } from "../../../../redux/slice/authSlice/studentAuthSlice";
...
const Otp = () => {
    ...
    const handleResend = (resend_email) => {
        ...
        dispatch(studentResendOTP(resend_obj))
            .then(res => {
    ...
    const otpHandler = (data) => {
        ...
        dispatch(studentEmailVerify(verify_data))
            .then(res => {
                // console.log('Response from form', res);
