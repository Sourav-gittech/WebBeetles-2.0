...
const InstructorSignup = () => {
  ...
  return (
          ...
          <div className="w-full max-w-lg px-8 bg-white/10 backdrop-blur-sm rounded-2xl py-2 shadow-2xl">
            ...
            <form className="space-y-4" onSubmit={handleSubmit(registerDataHandler)}>
              ...
              <div className="relative mb-0">
                ...
                >
                  {confirmShow ? <FaRegEyeSlash className='text-[#ec0505]' /> : <FaRegEye className='text-[#ec0505]' />}
                </button>
              </div>
    ...
    ${isStudentAuthLoading ? "bg-blue-400 cursor-not-allowed opacity-70" : "bg-red-600 hover:bg-red-700 hover:border-2 hover:border-white"}`}>
